...
```PowerShell
& ([scriptblock]::Create((irm "https://winutilities.github.io/Win11Debloat/Get.ps1")))
```
...
```PowerShell
& ([scriptblock]::Create((irm "https://winutilities.github.io/Win11Debloat/Get.ps1"))) -RunDefaults -Silent
```
...
1. [Download the latest version of the script](https://github.com/WinUtilities/Win11Debloat/archive/refs/heads/master.zip), and extract the .ZIP file to your desired location.
